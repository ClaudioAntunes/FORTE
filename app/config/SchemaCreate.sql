...
UNIQUE INDEX UNIQ_46C8B806EA000B103D9AB4A64DEF17BCE4289BF4 
(class_id, object_identity_id, field_name, ace_order), 
INDEX IDX_46C8B806EA000B103D9AB4A6DF9183C9 
(class_id, object_identity_id, security_identity_id), 
...
ADD CONSTRAINT FK_B3C77447A76ED395 
FOREIGN KEY (user_id) 
REFERENCES fos_user_user (id) 
ON DELETE CASCADE;



ALTER TABLE fos_user_user_group 
ADD CONSTRAINT FK_B3C77447FE54D947 
FOREIGN KEY (group_id) 
REFERENCES fos_user_group (id) 
ON DELETE CASCADE;



ALTER TABLE acl_object_identities 
ADD CONSTRAINT FK_9407E54977FA751A 
...
ADD CONSTRAINT FK_825DE2993D9AB4A6 
...
ALTER TABLE acl_object_identity_ancestors 
ADD CONSTRAINT FK_825DE299C671CEA1 
...
ADD CONSTRAINT FK_46C8B806EA000B10 
...
ALTER TABLE acl_entries 
ADD CONSTRAINT FK_46C8B8063D9AB4A6 
FOREIGN KEY (object_identity_id) 
REFERENCES acl_object_identities (id) 
ON UPDATE CASCADE ON DELETE CASCADE;
...
ALTER TABLE acl_entries 
ADD CONSTRAINT FK_46C8B806DF9183C9 
...
CREATE TABLE Defeito (id INT AUTO_INCREMENT NOT NULL, reclamacao VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACT
ER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB;